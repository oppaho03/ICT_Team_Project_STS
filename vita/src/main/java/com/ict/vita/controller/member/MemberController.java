	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				schema = @Schema(implementation = MemberResponseDto.class),
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":{\"id\":101,\"email\":\"user01@gmail.com\",,\"role\":\"USER\"\"name\":\"박윤성\",\"nickname\":\"user01\",\"birth\":null,\"gender\":\"\",\"contact\":null,\"address\":null,\"token\":\"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImVtYWlsIjoidXNlcjAxQGdtYWlsLmNvbSIsInN1YiI6IjEwMSIsImlhdCI6MTc0MzczNDY5MSwiZXhwIjoxNzQzNzM1NTkxfQ.zDpPYNEFxg-is-i5Kd3-ygDCgziP8Lsusnyp1bmb7nw\",\"created_at\":\"2025-04-04T11:29:54.933109\",\"updated_at\":\"2025-04-04T11:29:54.933109\",\"status\":1,\"meta\":[{\"meta_id\":10,\"meta_key\":\"picture\",\"meta_value\":\"https://lh3.googleusercontent.com/a/ACg8ocLFpG2QtJNS19tdH4FEvVPUUm8Fd0BV8uh4pIPh1m4uZAuynA=s96-c\"}]}}}"
				)
			) 
		),
		@ApiResponse( 
	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				...
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":[{\"id\":72,\"email\":\"ghkdwlgh123@naver.com\",\"role\":\"USER\",\"name\":null,\"nickname\":\"ghkdwlgh123\",\"birth\":null,\"gender\":\"\",\"contact\":null,\"address\":null,\"token\":null,\"created_at\":\"2025-03-27T19:03:12.562981\",\"updated_at\":\"2025-03-27T19:03:12.559982\",\"status\":9,\"meta\":[]},{\"id\":100,\"email\":\"baekjongwon33@naver.com\",\"name\":\"박구글\",\"nickname\":\"baekjongwon33\",\"birth\":null,\"gender\":\"\",\"contact\":null,\"address\":null,\"token\":\"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImVtYWlsIjoiYmFla2pvbmd3b24zM0BuYXZlci5jb20iLCJzdWIiOiIxMDAiLCJpYXQiOjE3NDM3MzM3NzEsImV4cCI6MTc0MzczNDY3MX0.cX0l1lnpk-7JlNRkizLtTMUmVhyTDq77Kc0IN-17jZk\",\"created_at\":\"2025-04-04T11:19:55.298957\",\"updated_at\":\"2025-04-04T11:19:55.298957\",\"status\":1,\"meta\":[{\"meta_id\":9,\"meta_key\":\"picture\",\"meta_value\":\"http://www.google.com\"}]},{\"id\":99,\"email\":\"baekjongwon22111@naver.com\",\"name\":null,\"nickname\":\"baekjongwon22111\",\"birth\":null,\"gender\":\"\",\"contact\":null,\"address\":null,\"token\":\"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImVtYWlsIjoiYmFla2pvbmd3b24yMjExMUBuYXZlci5jb20iLCJzdWIiOiI5OSIsImlhdCI6MTc0MzczMzE1MywiZXhwIjoxNzQzNzM0MDUzfQ.SYISAFjNXZCiWlY_o4mLbunyGvE8Rqtt6N_0g1BuCwg\",\"created_at\":\"2025-04-04T11:08:40.071055\",\"updated_at\":\"2025-04-04T11:08:40.071055\",\"status\":1,\"meta\":[{\"meta_id\":8,\"meta_key\":\"picture\",\"meta_value\":null}]}]}}"
				) 
			)
		),
		@ApiResponse( 
	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				schema = @Schema(implementation = MemberResponseDto.class),
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":{\"id\":48,\"email\":\"baekjongwon222@naver.com\",\"role\":\"USER\",\"name\":\"박종원\",\"nickname\":\"빽다방\",\"birth\":\"1950-03-17\",\"gender\":\"M\",\"contact\":null,\"address\":null,\"created_at\":\"2025-03-17T08:48:32.6060574\",\"updated_at\":\"2025-03-17T08:48:32.6060574\",\"status\":9}}}"
				)
			) 
		),
		@ApiResponse( 
	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				schema = @Schema(implementation = MemberResponseDto.class),
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":{\"id\":102,\"email\":\"wowwow@naver.com\",\"role\":\"USER\",\"name\":\"우와앙\",\"nickname\":\"wowwow\",\"birth\":\"2020-03-26\",\"gender\":\"F\",\"contact\":null,\"address\":null,\"token\":null,\"created_at\":\"2025-04-04T12:06:00.0706942\",\"updated_at\":\"2025-04-04T12:06:00.0706942\",\"status\":1,\"meta\":[]}}}"
				)
			) 
		),
		@ApiResponse( 
	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				schema = @Schema(implementation = MemberResponseDto.class),
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":{\"id\":101,\"email\":\"user01@gmail.com\",\"role\":\"USER\",\"name\":\"박윤성아재\",\"nickname\":\"퉁퉁이발\",\"birth\":null,\"gender\":\"M\",\"contact\":\"\",\"address\":\"서울사당\",\"token\":\"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImVtYWlsIjoidXNlcjAxQGdtYWlsLmNvbSIsInN1YiI6IjEwMSIsImlhdCI6MTc0MzczNDY5MSwiZXhwIjoxNzQzNzM1NTkxfQ.zDpPYNEFxg-is-i5Kd3-ygDCgziP8Lsusnyp1bmb7nw\",\"created_at\":\"2025-04-04T11:29:54.933109\",\"updated_at\":\"2025-04-04T12:12:44.0507804\",\"status\":1,\"meta\":[{\"meta_id\":10,\"meta_key\":\"picture\",\"meta_value\":\"https://lh3.googleusercontent.com/a/ACg8ocLFpG2QtJNS19tdH4FEvVPUUm8Fd0BV8uh4pIPh1m4uZAuynA=s96-c\"}]}}}"
				)
			) 
		),
		@ApiResponse( 
	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				schema = @Schema(implementation = MemberResponseDto.class),
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":{\"id\":101,\"email\":\"user01@gmail.com\",\"role\":\"USER\",\"name\":\"박윤성아재\",\"nickname\":\"퉁퉁이발\",\"birth\":null,\"gender\":\"M\",\"contact\":null,\"address\":\"서울사당\",\"token\":\"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImVtYWlsIjoidXNlcjAxQGdtYWlsLmNvbSIsInN1YiI6IjEwMSIsImlhdCI6MTc0MzczNDY5MSwiZXhwIjoxNzQzNzM1NTkxfQ.zDpPYNEFxg-is-i5Kd3-ygDCgziP8Lsusnyp1bmb7nw\",\"created_at\":\"2025-04-04T11:29:54.933109\",\"updated_at\":\"2025-04-04T12:13:47.9818825\",\"status\":1,\"meta\":[{\"meta_id\":10,\"meta_key\":\"picture\",\"meta_value\":\"https://lh3.googleusercontent.com/a/ACg8ocLFpG2QtJNS19tdH4FEvVPUUm8Fd0BV8uh4pIPh1m4uZAuynA=s96-c\"}]}}}"
				)
			) 
		),
		@ApiResponse( 
	...
	@ApiResponses({
		@ApiResponse( 
			...
			content = @Content(	
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(
					value = "{\"success\":1,\"response\":{\"data\":{\"member\":{\"id\":56,\"email\":\"aaaaauth@naver.com\",\"role\":\"USER\",\"name\":\"오인증\",\"nickname\":\"aaaaauth\",\"birth\":\"2020-03-26\",\"gender\":\"M\",\"contact\":null,\"address\":null,\"token\":\"eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsImVtYWlsIjoiYWFhYWF1dGhAbmF2ZXIuY29tIiwic3ViIjoiNTYiLCJpYXQiOjE3NDI5ODc2MjYsImV4cCI6MTc0Mjk4ODUyNn0.2AM3Ao2lKjwvR-lXLwWaz2CxDBamNcsK1s9zDjzdTlA\",\"created_at\":\"2025-03-26T19:46:34.129795\",\"updated_at\":\"2025-03-26T19:46:34.129795\",\"status\":0,\"meta\":[]},\"posts\":[]}}}"
				)
			) 
		),
		@ApiResponse( 
