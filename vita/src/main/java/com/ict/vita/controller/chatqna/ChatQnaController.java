...
public class ChatQnaController {
	...
	public ResponseEntity<?> getQna(
		...
		for(ChatQnaDto dto: findedQna) {
			result.add(ChatQnaResponseDto.toDto(dto));	
		}
